<div class="page-header" style="background: linear-gradient(135deg, #74ebd5, #acb6e5); padding: 20px; border-radius: 10px;">
    <h1 class="text-titles" style="color: #fff; text-align: center;">
        <i class="zmdi zmdi-store zmdi-hc-fw"></i> Bienvenido a <small><?php echo COMPANY; ?></small>
    </h1>
</div>

<div class="container-fluid" style="background-color: #f5f7fa; padding: 20px; border-radius: 10px;">
    <div class="row">
        <div class="col-xs-12">
            <p class="text-muted" style="text-align: center; font-size: 18px; color: #333;">
                BIENVENIDO ESTUDIANTE, A CONTINUACIÓN SE LE PRESENTAN LAS RESPECTIVAS LECCIONES, SELECCIONE LA QUE DESEE
            </p>
        </div>
    </div>
</div>
...
<style>
    ...
    .menu-item:hover {
        ...
        background-color: #008cba; /* Color al pasar el ratón */
    }
